 ...
 */
final class Version20200202141547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offers ADD zipcode INT NOT NULL, ADD city VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offers DROP zipcode, DROP city');
    }
}
